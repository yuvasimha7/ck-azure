...
class CARB_OFFSETS:
    def __init__(self,access_token):
        self.url = 'https://ww2.arb.ca.gov/sites/default/files/2022-07/nc-arboc_issuance.xlsx'
        self.access_token = access_token
        
    def ARB_Credit_Issuance(self):
        ...
        df['Provides DEBS'] = df['Provides DEBS'].replace('–', 'Non-DEBs')
        push_data2_ua(commit_table['CCO issuances and retirements Master'],df, self.access_token)
...
def main(mytimer: func.TimerRequest) -> None:
    ...
    co = CARB_OFFSETS(access_token)
    co.ARB_Credit_Issuance()
